...
export const DEMO_CASES: DemoCase[] = [
  {
    ...
    questions: [empathyQuestion("남용준"), safetyQuestion()],
  ...
  },
  {
    ...
    questions: [empathyQuestion("김도현"), safetyQuestion()],
  ...
  },
  {
    ...
    input: {
      customerName: "박지원",
      customerAccount: "351-0094-0004",
      payeeBank: "우리은행",
      payeeName: "(주)한별공인중개법인 에스크로",
